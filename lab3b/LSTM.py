...
from lab3b.layers.LSTMLayer import LSTMLayer
...
def main():
    model = Model([
        LSTMLayer(input_size=16, hidden_size=64, output_size=44, return_sequence=True, wScale=0.4),
        ReLU(),
        LSTMLayer(input_size=44, hidden_size=32, output_size=16, return_sequence=False, wScale=0.4),
        ReLU(),
        DenseLayer(16, 3),
        Softmax()
    ])
    ...
    model.train(X_train,y_train,10,0.01,25)
